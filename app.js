...
function sum(a, b) { //eslint-disable-lin
        ...
        let sum= a+b;
        return [sum,'The sum of '+ parseInt(a) +' and '+ parseInt(b) +' is '+ parseInt(sum) +'.'];
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    let array=multiply(dynamicArray);
    return array =[array,'The numbers 1,2,3,4,5 have a product of 120.']
}
